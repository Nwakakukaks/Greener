  ...
  },
  {
    ...
    field: (
      <TextField
        ...
        helperText="This amount will be automatically sent from your Greener balance to this fundraiser with interval set below"
      />
    ),
  },
  {
...
export const CreateRecurringDonation = ({
  ...
  const onSubmit = async (values: any) => {
    ...
    if (intervalHours <= 0 || intervalHours > 24 * 365 * 100) {
      addNotification(NotificationType.ERROR, "Too long!.");
      return;
    }
  ...
  return (
    <StyledPaper sx={{ mt: 3 }}>
      <Typography component="h1" variant="h5">
        setup a recurring payment to this fundraiser
      </Typography>
      <GenericForm
        onSubmit={onSubmit}
        validate={validate}
