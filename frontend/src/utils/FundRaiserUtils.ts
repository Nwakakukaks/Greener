...
FUNDRAISER_CATEGORY[FundRaiserCategory.CLIMATE] = "climate";
FUNDRAISER_CATEGORY[FundRaiserCategory.NATURE_HAZARDS] = "nature Emergencies";
FUNDRAISER_CATEGORY[FundRaiserCategory.PLANTS_TREES] = "plants/trees";
