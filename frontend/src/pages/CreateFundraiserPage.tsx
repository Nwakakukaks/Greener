...
import * as factoryAbi from "../artifacts/contracts/GreenerFactory.sol/GreenerFactory.json";
...
const formFields: GenericFormField[] = [
  ...
  },
  {
    ...
    field: (
      ...
      >
        <MenuItem value={String(FundRaiserCategory.CLIMATE)}>climate support</MenuItem>
        <MenuItem value={String(FundRaiserCategory.NATURE_HAZARDS)}>earthquake,forest-fire etc. emergencies</MenuItem>
        <MenuItem value={String(FundRaiserCategory.PLANTS_TREES)}>plant a tree causes</MenuItem>
  ...
  },
  {
    ...
    field: (
      <TextField
        ...
        helperText="A good fundraiser title can help your campaign!"
      />
    ),
  },
  {
